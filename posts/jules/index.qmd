...
Thankfully, the website also included some searchable tables to narrow things down a bit. Interestingly, Pointe-aux-Trembles comes up as a city in Québéc and importantly, only five churches are listed. By zooming in on the map, we could see only 3 churches in the area. The first one we clicked on was established in 1959, so that was eliminated. The next one we clicked on, [Église du Saint-Enfant-Jésus de la Pointe-aux-Trembles](https://gcatholic.org/churches/canada-quebec/13440) was established in 1678 which was promising! We also liked that the name of the church was the same as the neighborhood and matched the marriage card.
